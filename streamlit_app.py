...
for index, row in price_tracker_data.iterrows():
...
price_tracker_data = price_tracker_data[['year_month_day','pacific_datetime', 'product', 'channel', 'list_price', 'sale_amount', 'sale_price', 'url']]
...
# Customize plot
plt.title('Sale Price vs List Price Over Time')
plt.xlabel('Date')
plt.ylabel('Price')
